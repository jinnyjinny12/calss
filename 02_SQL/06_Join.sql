...
-- 두가지 테이블을 합쳐서 보여주고 싶을 때 join 을 이용한다,
-- join 을 이용한다면

select
	m.menu_code,
	m.menu_name,
	m.category_code, -- m에도 있고  c에도 있는데?!
	c.category_name,
	m.menu_price
...
select 
	a.category_name,
	b.menu_name
	from tbl_category a -- category 테이블이 기준이 된다
...
select 
	a.category_name,
	b.menu_name
	from tbl_menu b -- 메뉴 테이블이 기준이 된다.
...
-- 자체 문제
-- category_name을 기준을 menu_name 과 menu_price 를 출력하시오. 단 menu_price 는 비싼 거부터 출력하세요!

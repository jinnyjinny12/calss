package com.ohgiraffers.section01.arthimetic;

public class Application01 {
    public static void main(String[] args) {
        /*
        * 산술 연산자
        * 산술 연산자는 주로 사칙연산과 관련된 연산자로 가장 기본적면서도 많이 사용되는 연산자이다.
        * 연산의 실행이 가능하기 위해 필요한 값이나 변수가 두 개인 이항 연산자로 분류되며
        * 피연산자들의 연산 방향은 왼족에서 오른쪾이다.
        * */

        /*
        * 산술연산자의 종류
        * '+': 왼쪽의 피연산자에 오른쪽의 피연산자를 더함.
        * '_': 왼쪾의 피연산자에 오른쪽 피연산자를 뺌
        * '/': 왼쪽의 피연산자에 오른쪽의 피연산자로 나눔.
        * '*': 왼쪽의 피연산자를 오른쪽의 피연산자로 곱함.
        * '%': 왼쪾의 피연산자를 오른쪾의 피연산자로 나눈 나머지를 반환.
        * */

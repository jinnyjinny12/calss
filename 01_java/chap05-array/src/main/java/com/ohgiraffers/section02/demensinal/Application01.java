...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        *
        * 배열의 인ㅅ덱스마다 또 다른 배열의 주소를 보관하는 배열을 의미한다.
        ...
        * 표현식
        * 자료현[][] 변수명 = new 자료형 [길이][길이]
        *
        * */

        // 배열을 표현하는 표현식으로 아래와 같이 배열을 선언할 숭 ㅣㅅ다.
        ...
        iarr1  = new int [3][]; // 첫번째 배열의 길이를 3으로 놓고 두 번째 배열의 길이를 지정하지 않음.
        iarr1[0] = new int[5];
        iarr1 [1] = new int[4];
        iarr1 [2] = new int [2];

       // iarr1 [3] = new int [6]; // 3번째 배열에다가 배열길이 6개를 지정. 배열의 길이를 3개까지 지정ㅇ해줬는데

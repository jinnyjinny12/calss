...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        * 바에서 제네릭이란 데이터의 타입을 일반화 한다는 의미를 가진다.
        *
        ...
        *
        * 제네릭 프로그래밍
        * 데이터의 형식에 의존하지 않고 하나의 값이 여러 다른 데이터 타입을 가질 수 잇는 기술에 중점을 두어
        * 재사용성을 높일 수 잇는 프로그래밍 방식이다.
        *
        * */
        ...
        GenericTest<String> gt2 = new GenericTest(); // <> 자료형을 선언함.
        gt2.setValue("안녕하세요");
